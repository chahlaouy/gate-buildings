                    ...
                    <div class="overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 border-b border-gray-200">
                            ...
                            <label class="block mb-4">
                                ...
                                <textarea class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="description" id="description"></textarea>
                            </label>
                            <label class="block">
            ...
            <div class="w-56 px-2">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                    <div class="p-2 bg-white border-b border-gray-200">
                        <button type="submit" class="py-2 w-full rounded text-gray-700 mb-4"  style="background: #ff6700">Publié</button>
                    </div>
